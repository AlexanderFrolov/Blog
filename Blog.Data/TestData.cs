        ...
        public static void EnterDataToBlogDb()
        {
            using (var context = new BlogContext())
            {
                ...
                var post1 = new Post
                {
                    ...
                    User = user1,
                    Contetnt = "1. Даже после свадьбы нельзя сказать, что человек находится в полной вашей власти. Не стоит переделывать человека, которого вы выбрали." +
                ...
                var post2 = new Post
                {
                    ...
                    User = user2,
                    Contetnt = "В калифорнийском Карлсбаде, который расположен недалеко от Лос-Анджелеса, есть одно из самых привлекательных мест в Америке для маленьких" +
                ...
                var post3 = new Post
                {
                    ...
                    User = user3,
                    Contetnt = "Никто из нас не хочет оказаться погрязшим в долговых обязательствах, мы хотим быть финансово независимыми, хотим иметь достаточно" +
                ...
                var post4 = new Post
                {
                    ...
                    User = user1,
                    Contetnt = "Гавайи являются самой длинной цепью в мире, протяженность островов составляет 1,600 миль. Основные острова расположены немного южнее" +
